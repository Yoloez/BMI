    ...
    <div className="w-full">
      <Card className="p-8 shadow-lg border-0">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-muted-foreground text-sm">Hitung kebutuhan kalori harian Anda berdasarkan metabolisme basal</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-3">
              <button
                ...
                className={`flex-1 py-3 rounded-lg font-medium transition-all duration-300  cursor-pointer ${gender === "male" ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground hover:bg-muted/80"}`}
              >
                Laki-laki
              </button>
              <button
                onClick={() => setGender("female")}
                className={`flex-1 py-3 rounded-lg font-medium transition-all duration-300 cursor-pointer ${gender === "female" ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground hover:bg-muted/80"}`}
              >
                Perempuan
              </button>
            </div>
          ...
          <div className="space-y-2">
            ...
            <Input id="age" type="number" placeholder="Masukkan usia Anda" value={age} onChange={(e) => setAge(e.target.value)} className="h-12 text-base border-2 border-border focus:border-primary transition-colors" />
          </div>
          ...
          <div className="space-y-6 animate-in fade-in duration-300">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="bg-jarang rounded-lg p-4 border border-border/50">
                ...
                <div className="bg-kadang rounded-lg p-4 border border-border/50">
                ...
                <div className="bg-moderate rounded-lg p-4 border border-border/50">
                ...
                <div className="bg-aktif rounded-lg p-4 border border-border/50">
                ...
                <div className="bg-sangat-aktif rounded-lg p-4 border border-border/50 md:col-span-2">
            ...
            <div className="bg-muted rounded-lg p-4 border border-border/50">
              <p className="text-xs text-muted-foreground leading-relaxed">
                <span className="font-semibold text-foreground">Catatan:</span> Gunakan nilai TDEE sesuai dengan tingkat aktivitas Anda untuk mempertahankan berat badan. Kurangi 300-500 kalori untuk menurunkan berat badan, atau tambahkan
      ...
      {/* Footer */}
      <p className="text-center text-xs text-white mt-6">Hasil ini hanya untuk referensi. Konsultasikan dengan ahli gizi atau dokter untuk rekomendasi yang lebih akurat.</p>
    </div>
  );
}
